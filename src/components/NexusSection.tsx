    ...
    <section className="bg-background dark:bg-background-dark text-foreground dark:text-foreground-dark py-20 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-xl text-center mb-16 max-w-3xl mx-auto">
          Society and the economy are 100% reliant on nature. SITUS operates at the core of our intertwined climate, biodiversity, and social systems to mitigate risks and ensure resilience in the face of rapid environmental changes.
        </p>
