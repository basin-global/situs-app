...
import { ChevronDown, Wallet, User, LogOut, Settings, UserCircle, Menu } from 'lucide-react'
    ...
    <header className={`bg-gradient-to-r from-secondary to-primary text-white shadow-lg relative z-[40] py-3`}>
      <div className="container mx-auto px-4 max-w-7xl mobile-safe-container">
        <div className="mobile-header-container flex justify-between items-center relative">
          ...
          <div className="flex items-center space-x-1 md:space-x-4 flex-shrink-0 z-[30]">
          ...
          <div className="flex items-center space-x-1 md:space-x-4 flex-shrink-0 z-[100]">
            {shouldShowOGChooserAndNavigation && (
              <>
                {/* Mobile menu button - adjusted padding */}
